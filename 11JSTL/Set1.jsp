...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%@ taglib prefix="fmt" uri ="http://java.sun.com/jsp/jstl/fmt" %> <!-- jstl의 formatting 태그 사용 -->
 <!-- formatting : 숫자, 날짜, 시간 포멧 지정(다국어) -->
 <%@ taglib prefix="x" uri = "http://java.sun.com/jsp/jstl/xml" %> <!-- jstl의 xml태그 -->
 <!-- xml : 확장자가 xml인 데이터 파싱 -->
 <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
 <!-- function : 컬렉션 , 문자열 처리 -> el에서 사용할 수 있는 메서드 제공 -->
 <%@ taglib prefix="sql" uri ="http://java.sun.com/jsp/jstl/sql" %>
 <!-- sql : 데이터베이스 연결 및 쿼리 실행 -> jdbc api를 사용하기 때문에 활용성 없다-->
<!DOCTYPE html><html><head><meta charset="UTF-8">
<title>JSTL 테스트</title></head>
<body>
     <!-- 변수 선언 -->
     <c:set var="direcVar" value ="100"/>
     <c:set var="eVar" value="${ direcVar mod 5 }"/> 
     ...
     <ul>
        <li>directVar : ${ pageScope.direcVar } </li>
        <li>eVar : ${ eVar } </li>
        <li>expVar : ${ expVar } </li>
