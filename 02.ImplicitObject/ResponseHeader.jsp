...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    response.addDateHeader("resp_date", add_date); // 응답헤더에 resp_dae 이름으로 추가
    
    int add_int = Integer.parseInt(request.getParameter("add_int"));// main에서 넘어옴
    // 문자열을 숫자로 변경
    response.addIntHeader("resp+int", add_int); // 응답헤더에 정수 추가
...
<body>
   <h2> ResponsMain.jsp에서 넘어온 응답헤더 출력 </h2>
   <%
